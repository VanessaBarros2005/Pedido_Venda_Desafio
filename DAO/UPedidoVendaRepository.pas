...
begin
  ...
  try
    ...
    try
      ...
      begin
        LQuery.SQL.Text :=
          'INSERT INTO PEDIDOVENDA (CODIGO, DATAEMISSAO, CODIGO_CLIENTE, VALORTOTAL) ' +
      ...
      LQuery.SQL.Clear;
      LQuery.SQL.Text :=
        'INSERT INTO PEDIDOITEM (CODIGO_PEDIDOVENDA, CODIGO_PRODUTO, QUANTIDADE, VALORUNITARIO, VALORTOTAL) ' +
        'VALUES (:CODIGO_PEDIDOVENDA, :CODIGO_PRODUTO, :QUANTIDADE, :VALORUNITARIO, :VALORTOTAL)';
